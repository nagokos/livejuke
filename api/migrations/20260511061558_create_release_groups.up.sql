...
CREATE INDEX idx_release_groups_approved ON release_groups(approved_at) WHERE deleted_at IS NULL;
CREATE INDEX idx_release_groups_title    ON release_groups(title)       WHERE deleted_at IS NULL;
